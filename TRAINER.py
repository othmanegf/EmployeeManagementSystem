from IEmployee import Employee  # Assuming the correct filename is "employee.py"
from IR import IR
...
class Trainer(Employee, IR):
    ...
    def __init__(self, mtle=0, nom="GF", dateNaissance="15/07/2004", dateEmbauche="15/01/2024", salaireBase=8000):
        """
